...
The memory allocation aspect which is paramount especially for the concatenation functionality is done by the *genCopyArray* in `CGwats.ipynb` and is shown below.
